...
public class UnitManager : MonoBehaviourPunCallbacks
{
	...
	[SerializeField] private string _localizacaoUnitPrefab;
    ...
    {
		SpawnUnits(GameManager.Instance.PlayerSide);
	}
	...
	{
		Tile spawnTile = GridManager.Instance.GetTileAtPosition((GameManager.Instance.PlayerSide == exercito) ? pos : (new Vector2(9, 9) - pos));
