...
public class HUDManager : MonoBehaviour
{
	...
	[SerializeField] private Sprite _MoveTurnIconSprite, _AttackTurnIconSprite;
	...
	public void ShowTileUnit(Tile tile)
	{
		...
		if (tile.OccupiedUnit)
		{
			...
			if (tile.OccupiedUnit.UnitColor == GameManager.Instance.PlayerSide)
			{
	...
	private void TranslateTurnInfoToSide()
	{
		...
		if (GameManager.Instance.PlayerSide == GameManager.Instance.GetPlayerTurn())
		{
